...
const mockdata = [
  ...
  { label: "Exhibitor", icon: Presentation, link: "/admin/exhibitor" },
  {
    ...
    icon: Users,
    links: [
      { label: "All Visitors", link: "/admin/visitor" },
      { label: "Booth Visitors", link: "/admin/visitor/booth" },
      { label: "Booth Visitors Info", link: "/admin/visitor/info" },
      { label: "Webinar Attendees", link: "/admin/visitor/webinar" },
      { label: "Webinar Attendees Info", link: "/admin/visitor/webinar-info" },
      { label: "Doorprize", link: "/admin/visitor/randomizer" },
      { label: "Doorprize v2", link: "/admin/visitor/randomizer2" },
    ],
  },
